                        ...
                        switch (op) {
                            ...
                            case 4:
                                if (user.getP1() != null && user.getP2() != null) {
                                    ...
                                    user.nuevoProducto(user == u1 ? 10 : 20,
                            ...
                            case 5:
                                if (user2.getP1() != null || user2.getP2() != null) {
                                    ...
                                    System.out.print("¿Quieres comprar algún producto? (S/N): ");
                                    teclado = s.nextLine();

                                    if (teclado.equals("S")) {
                                        System.out.print("Introduce el ID del producto que quieres comprar: ");
                                        ...
                                        if (user2.getP1() != null && user2.getP1().getId() == idProducto) {
                                            ...
                                            else if (user2.getpPedido2() == null)
                                                user2.setpPedido2(user2.getP1());

                                        } else if (user2.getP2() != null && user2.getP2().getId() == idProducto) {
                                            if (user2.getpPedido1() == null)
                                                user2.setpPedido1(user2.getP2());
                                            else if (user2.getpPedido2() == null)
                                                user2.setpPedido2(user2.getP2());
                                        } else {
                                            System.out.println("El ID introducido no es válido.");
                                        }
                                    }
                                } else {
                                    System.out.println("No hay productos disponibles a la venta.");
                                }
