                                ...
                                do {
                                    ...
                                    if (op <= 3 && op >= 1) {
                                        do {
                                            ...
                                            teclado = s.nextLine();
                                            if(!user.cambiaDatoPersonal(op, teclado)) System.out.println("El valor introducido no es válido, pulsa ENTER para continuar...");
                                            else System.out.println("Cambios realizados correctamente, pulsa ENTER para continuar...");
